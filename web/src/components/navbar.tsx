...
const Navbar: React.FC = () => {
  return (
    <nav className="bg-blue-500 rounded-sm shadow-md">
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        {/* Logo */}
        <div className="flex items-center">
          <div className="font-bold text-xl text-gray-800">
            <Link href="/">Happenings Hub</Link>
          </div>
        </div>
        ...
        <div className="flex items-center">
          ...
          <span className="ml-2 text-gray-800">Jakarta</span>
        </div>
        ...
        <div className="hidden md:flex space-x-4">
          ...
          <Link href="/signup" className="text-gray-800 hover:text-blue-500">
            Sign Up
          </Link>
        </div>
      </div>
